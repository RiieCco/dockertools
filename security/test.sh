...
echo "curl"
export HASH="$(curl -F 'file=@/Users/riiecco/Desktop/diva.apk' http://192.168.2.23:8000/api/v1/upload -H "Authorization:39f6fd6d1c6ef13a1b81445ebcdc6f135c5d15ac7b6c0c8507a19f89a1988765" | grep "hash" | cut -d: -f2 | cut -d \" -f2)"
echo "export"
echo $HASH
